...
const constants = eris_2.Constants;
/// 初始化、啟動
const bot = (0, eris_1.default)(config_1.BOT_TOKEN);
/// 指令前綴
const PREFIX = "vl!";
/// DC
let serverGuild;
...
//----------------------------------------------------------------
/// 顯示認證會員的按鈕訊息
const displayVerifiedLinkButton = () => __awaiter(void 0, void 0, void 0, function* () {
    // 啟動時先將頻道內所有訊息都先刪除
    const verifyChannel = bot.getChannel(config_1.VERIFY_CHANNEL_ID);
    const messageList = yield verifyChannel.getMessages({ limit: 1000 });
    messageList.forEach((message) => __awaiter(void 0, void 0, void 0, function* () {
        yield verifyChannel.deleteMessage(message.id);
    }));
    // 建立新的按鈕訊息
    const content = {
        embed: {
...
bot.on("messageCreate", (msg) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // 檢查是否為Webhook訊息
    const isWebhookMessage = msg === null || msg === void 0 ? void 0 : msg.webhookID;
    if (isWebhookMessage) {
        return;
    }
    // 頻道資訊
...
bot.on("interactionCreate", (interaction) => {
    if (interaction instanceof eris_2.ComponentInteraction) {
